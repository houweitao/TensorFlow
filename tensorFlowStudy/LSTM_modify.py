# -*- coding: utf-8 -*-
# _author_ = 'hou'
# _project_: LSTM_modify
# _date_ = 16/12/6 下午6:49
...
def RNN(X, weights, biases):
    ...
    typeAll = [tf.matmul(i, weights['event']) + biases['event'] for i in outputs]  # TODO
    polarityAll = [tf.matmul(i, weights['event']) + biases['event'] for i in outputs]  # TODO
    degreeAll = [tf.matmul(i, weights['event']) + biases['event'] for i in outputs]  # TODO
    modalityAll = [tf.matmul(i, weights['event']) + biases['event'] for i in outputs]  # TODO
